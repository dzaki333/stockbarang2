            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark">
                <div class="sb-sidenav-menu">
                    <div class="nav flex-column">
                        <a class="nav-link" href="index.php"><div class="sb-nav-link-icon"><i class="fas fa-box"></i></div> Dashboard</a>
                        <a class="nav-link" href="masuk.php"><div class="sb-nav-link-icon"><i class="fas fa-dolly"></i></div> Barang Masuk</a>
                        <a class="nav-link active" href="keluar.php"><div class="sb-nav-link-icon"><i class="fas fa-dolly-flatbed"></i></div> Barang Keluar</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-2 mb-4"><i class="fas fa-dolly-flatbed"></i> Barang Keluar</h1>

                    <div class="card mb-4">
                        <div class="card-header">
                            <button type="button" class="btn btn-primary shadow-sm" data-toggle="modal" data-target="#myModal">
                                 <i class="fas fa-minus-circle"></i> Tambah Barang Keluar
                            </button>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                                   ...
                                   <?php
                                    $no = 1;
                                    $ambil = mysqli_query($conn, "SELECT k.*, s.namabarang, s.stock FROM keluar k JOIN stock s ON k.idbarang = s.idbarang");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $tanggal; ?></td>
                                            <td><?= $namabarang; ?></td>
                                            <td><span class="badge badge-danger">-<?= $jumlah; ?></span></td>
                                            <td><?= $stock; ?></td>
                                        </tr>
                                    <?php } ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <div class="modal-header" style="background: linear-gradient(90deg, #42a5f5, #90caf9); color: white; border-top-left-radius: 12px; border-top-right-radius: 12px;">
                    <h5 class="modal-title mb-0"><i class="fas fa-minus-circle"></i> Tambah Barang Keluar</h5>
                </div>
            ...
            <form method="post">
                <div class="modal-body" style="background-color: #f9fbff;">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary" name="addbarangkeluar"><i class="fas fa-paper-plane"></i> Simpan</button>
                    </div>
                </div>
                </form>
            </div>
